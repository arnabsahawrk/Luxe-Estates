  ...
  return (
    <section className="text-center space-y-4 md:space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center gap-3">
        <div className="flex justify-center items-center flex-col space-y-2 px-4">
        ...
        <div className="flex justify-center items-center flex-col md:col-span-2 lg:col-auto space-y-2 px-4">
